...
public class Dashboard extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        studentsLabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
        studentsValue = new javax.swing.JLabel();
        studentsValue.setFont(new Font("Segoe UI", Font.BOLD, 50));
        card2 = new javax.swing.JPanel();
        tearcherLabel = new javax.swing.JLabel();
        tearcherLabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
        teacherValue = new javax.swing.JLabel();
        teacherValue.setFont(new Font("Segoe UI", Font.BOLD, 50));
        card3 = new javax.swing.JPanel();
        courseLabel = new javax.swing.JLabel();
        courseLabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
        courseValue = new javax.swing.JLabel();
        courseValue.setFont(new Font("Segoe UI", Font.BOLD, 50));
        card4 = new javax.swing.JPanel();
        loginLabel = new javax.swing.JLabel();
        loginLabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
        loginValue = new javax.swing.JLabel();
        loginValue.setFont(new Font("Segoe UI", Font.BOLD, 50));
        ...
        descriptionLabel.setText("Login Activity");
    ...
    private void init() throws IOException {
        ...
        databasePanel.add(new JLabel("EEE Students"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/students.csv", "EEE", 5)));
        databasePanel.add(new JLabel("Pharmacy Students"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/students.csv", "Pharm", 5)));
        databasePanel.add(new JLabel("GEB Students"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/students.csv", "GEB", 5)));
        databasePanel.add(new JLabel("Mathematics Students"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/students.csv", "Mathematics", 5)));
        databasePanel.add(new JLabel("ICE Students"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/students.csv", "ICE", 5)));
        databasePanel.add(new JLabel("BBA Students"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/students.csv", "BBA", 5)));
        databasePanel.add(new JLabel("Economics Students"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/students.csv", "Economics", 5)));
        databasePanel.add(new JLabel("English Students"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/students.csv", "English", 5)));
        databasePanel.add(new JLabel("LLB Students"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/students.csv", "LLB", 5)));
        databasePanel.add(new JLabel("Sociology Students"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/students.csv", "Sociology", 5)));
        databasePanel.add(new JLabel("Information Studies Students"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/students.csv", "IS", 5)));
        databasePanel.add(new JLabel("PPHS Students"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/students.csv", "PPHS", 5)));

        databasePanel.add(new JLabel("<html><b> ** Faculty Members -</b></html>"), "wrap");
        databasePanel.add(new JLabel("Computer Science Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "Computer Science", 2)));
        databasePanel.add(new JLabel("Civil Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "Civil", 2)));
        databasePanel.add(new JLabel("EEE Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "EEE", 2)));
        databasePanel.add(new JLabel("Pharmacy Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "Pharm", 2)));
        databasePanel.add(new JLabel("GEB Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "GEB", 2)));
        databasePanel.add(new JLabel("Mathematics Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "Mathematics", 2)));
        databasePanel.add(new JLabel("ICE Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "ICE", 2)));
        databasePanel.add(new JLabel("BBA Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "BBA", 2)));
        databasePanel.add(new JLabel("Economics Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "Economics", 2)));
        databasePanel.add(new JLabel("English Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "English", 2)));
        databasePanel.add(new JLabel("LLB Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "LLB", 2)));
        databasePanel.add(new JLabel("Sociology Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "Sociology", 2)));
        databasePanel.add(new JLabel("Information Studies Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "IS", 2)));
        databasePanel.add(new JLabel("PPHS Faculty Members"));
        databasePanel.add(new JLabel(countMatchingRecords("./csv/faculty.csv", "PPHS", 2)));
        ...
        // University Panel
        universityPanel.setLayout(new MigLayout("wrap 2", "[][]20[][]"));

        universityPanel.add(new JLabel("<html><b> ** Login Users -</b></html>"), "wrap");
        universityPanel.add(new JLabel("Admin Users"));
        universityPanel.add(new JLabel(countMatchingRecords("./csv/registration.csv", "ADMIN", 2)));

        universityPanel.add(new JLabel(""), "wrap");
        universityPanel.add(new JLabel("<html><b> ** Server Details -</b></html>"), "wrap");
        universityPanel.add(new JLabel("Login Success"));
        universityPanel.add(new JLabel(countMatchingRecords("./csv/login.csv", "Success", 4)));
        universityPanel.add(new JLabel("Login Failures"));
        universityPanel.add(new JLabel(countMatchingRecords("./csv/login.csv", "Failure", 4)));
        ...
        // Set the preferred size for the scroll pane to ensure proper layout
    ...
    // Read and form the jtabel
    private static JTable readCSVFile(String filePath) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            if (line != null) {
                ...
                // Read the remaining lines and add data to the table
                while ((line = reader.readLine()) != null) {
